...
<html>
<head>
    <title>Reporte de Compras Detallado y Acumulado</title>
    <style>
...
<body>
    ...
    <div class="compra-item">
        ...
        <h2 style="font-size: 13pt; color: #d41002; border-bottom: 1px solid #ccc; padding-bottom: 5px; margin-bottom: 10px;">
    ...
    <div style="text-align: center; padding: 50px;">
        <p style="font-size: 14pt; color: #005691;">No se encontraron registros de compras con los filtros especificados.</p>
    </div>
    @endforelse
