...
<body>
    ...
    <p><a href="{{ route('admin.psicologia.maestros.citas.index') }}" style="padding: 10px 15px; background-color: #0284c7; color: white; text-decoration: none; border-radius: 5px;">Ver mis Citas</a></p>
