...
<head>
    ...
    <meta name="description"
        content="Bienestar Estudiantil UPTP Juan de Jesús Montilla - Acarigua, Portuguesa. Salud, deportes, apoyo académico y programas sociales para estudiantes.">
...
<body>
    ...
    <header class="site-header">
        <div class="container header-inner">
            <div class="brand">
                <img src="{{ asset('img/uptp-logo.webp') }}" alt="UPTP" class="logo">
    ...
    <!-- HERO -->
    <section id="inicio" class="hero" aria-label="Hero"
        style="background-image: url('{{ asset('img/unnamed.webp') }}');">
        ...
        <div class="container">
            ...
            <div class="features-grid">
                ...
                <div class="feature" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p>Programas de prevención, charlas y seguimiento nutricional para una vida estudiantil saludable.
                    </p>
                </div>
    ...
    <section id="sobre-nosotros" class="visual-reference" data-aos="fade-up">
        <div class="container visual-inner">
            <div class="visual-graphic">
                <div class="rect tall" style="background-image:url('{{ asset('img/foto4b.webp') }}')"></div>
                <div class="rect" style="background-image:url('{{ asset('img/foto5b.webp') }}')"></div>
                <div class="circle overlap" style="background-image:url('{{ asset('img/foto1b.webp') }}')"></div>
            </div>
            ...
            <div class="visual-text">
                ...
                <p>La Unidad de Bienestar Estudiantil acompaña a la comunidad de la UPTP Juan de Jesús Montilla con
                    servicios de apoyo psicológico, salud, actividades deportivas, programas de becas y asesoría
                    socioacadémica. Nuestro objetivo es promover el desarrollo integral y la calidad de vida de los
                    estudiantes.</p>
                <div class="text-circles">
                    <img src="{{ asset('img/foto2b.webp') }}" alt="Equipo UPTP" class="text-circle c1">
                    <img src="{{ asset('img/foto3b.webp') }}" alt="Actividades" class="text-circle c2">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="cta-grid">
                ...
                <a class="cta-card" href="#actividades">
                    ...
                    <h4>Deporte y Recreación</h4>
                    <p>Ligas internas, entrenamientos y actividades recreativas para fomentar la salud física, trabajo
                        en equipo y convivencia.</p>
                </a>

                <a class="cta-card" href="#programas">
                    <div class="cta-icon"><i class="fas fa-hand-holding-usd"></i></div>
                    <h4>Programas de Apoyo y Becas</h4>
                    <p>Orientación para postular a becas, ayudas económicas y programas sociales que facilitan la
                        permanencia y el éxito académico.</p>
                </a>
            </div>
        </div>
    </section>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            <div class="thumb" style="background-image:url('{{ asset('img/estudiante.webp') }}')">
                            </div>
                            <blockquote>
                                "El apoyo psicológico me ayudó a manejar la ansiedad y mejorar mi rendimiento
                                académico."
                                <cite>- José R.</cite>
                            </blockquote>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            <div class="thumb" style="background-image:url('{{ asset('img/estudiante2.webp') }}')">
                            </div>
                            <blockquote>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            <div class="thumb" style="background-image:url('{{ asset('img/estudiante3.webp') }}')">
                            </div>
                            <blockquote>
        ...
        <div class="footer-top">
            <div class="container footer-top-inner">
                <div class="footer-left">
                    <img src="{{ asset('img/uptp-logo.webp') }}" alt="UPTP" class="logo-foot">
                ...
                <div class="footer-right">
                    ...
                    <div class="social-icons">
                        <a href="https://www.instagram.com/bienestaruptp/" target="_blank" rel="noopener"
                            aria-label="Instagram" class="social">
            ...
            <div class="container footer-mid-inner">
                ...
                <div class="col contact">
                    ...
                    <p><i class="fas fa-envelope"
                            style="margin-right: 8px; color: var(--color-primary);"></i>info@uptp.edu.ve</p>
                    <p><i class="fas fa-phone"
                            style="margin-right: 8px; color: var(--color-primary);"></i>0414-9548887</p>
