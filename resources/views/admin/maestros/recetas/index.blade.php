                ...
                <div class="rd-filters">
                    <div class="d-flex gap-3 align-items-center mb-3">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.maestros.recetas.index', array_merge(request()->except('activo'), ['activo' => 1])) }}"
                                class="btn {{ request('activo', 1) == 1 ? 'btn-primary' : 'btn-outline-primary' }}">
                                Activos
                            </a>
                            <a href="{{ route('admin.maestros.recetas.index', array_merge(request()->except('activo'), ['activo' => 0])) }}"
