        ...
        <div class="card card-outline card-primary">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="javascript:void(0)" onclick="GoTo('{{ route('admin.maestros.productos.create') }}')" class="btn btn-primary">
                    ...
                    <tbody>
                        ...
                        @foreach ($productos as $producto)
                            <tr>
                                ...
                                <td style="text-align: center;">
                                    <a href="javascript:void(0)" onclick="GoTo('{{ route('admin.maestros.productos.edit', $producto->id) }}')" class="btn btn-warning" title="Editar">
                                            <i class="fas fa-edit text-white"></i>
                                    </a>
                                    <a href="javascript:void(0)" onclick="GoTo('{{ route('admin.maestros.productos.show', $producto->id) }}')" class="btn btn-info"><i class="fas fa-eye"></i></a>
