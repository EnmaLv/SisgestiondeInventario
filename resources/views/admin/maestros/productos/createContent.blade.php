    ...
    <div class="col-md-12 m-auto">
        <div class="card card-primary">
            ...
            <div class="card-body" style="display: block;">
                <form id="createForm" action="{{ route('admin.maestros.productos.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="form-group col-md-2" style="display: inline-block;">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" value="{{ old('precio_compra') }}" class="form-control"
                                            id="precio_compra" name="precio_compra" placeholder="$$">
                                    </div>
                                    @error('precio_compra')
                                        <div class="alert text-danger p-0 m-0">
                                            <b>{{ 'Este campo es obligatorio.' }}</b>
                                ...
                                <div class="form-group col-md-2" style="display: inline-block;">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" value="{{ old('precio_venta') }}" class="form-control"
                                            id="precio_venta" name="precio_venta" placeholder="$$">
                                    </div>
                                    @error('precio_venta')
                                        <div class="alert text-danger p-0 m-0">
                                            <b>{{ 'Este campo es obligatorio.' }}</b>
                                ...
                                <div class="form-group col-md-2" style="display: inline-block;">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" value="{{ old('stock_minimo') }}" class="form-control"
                                            id="stock_minimo" name="stock_minimo" placeholder="Minimo">
                                    </div>
                                    @error('stock_minimo')
                                        <div class="alert text-danger p-0 m-0">
                                            <b>{{ 'Este campo es obligatorio.' }}</b>
                                ...
                                <div class="form-group col-md-2" style="display: inline-block;">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" value="{{ old('stock_maximo') }}" class="form-control"
                                            id="stock_maximo" name="stock_maximo" placeholder="Maximo">
                                    </div>
                                    @error('stock_maximo')
                                        <div class="alert text-danger p-0 m-0">
                                            <b>{{ 'Este campo es obligatorio.' }}</b>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <img id="imgPreview" style="width: 100%; height: auto;" src="#"
                                            alt="">
                                        <script>
