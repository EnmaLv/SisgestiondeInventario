...
<div class="rd-card p-4 mb-4 d-flex justify-content-between align-items-center">
    <div>
        <h1 class="m-0 rd-title-sm" style="font-size:1.4rem;">Editar Jornada de Beca</h1>
    ...
    <div class="col-md-10 m-auto">
        <div class="rd-card p-4">
            <div class="rd-card-header mb-4">
                <h3 class="rd-title-sm">Modificar Detalles de la Jornada</h3>
                <div>
            ...
            <form action="{{ route('admin.becas.jornada.update', $jornada->id) }}" method="POST"
                ...
                <div class="row">
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text"
                                class="form-control rd-filter-input @error('nombre_jornada') is-invalid @enderror"
                                name="nombre_jornada" value="{{ old('nombre_jornada', $jornada->nombre_jornada) }}"
                ...
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        <label class="font-weight-bold">Fecha de Inicio de Solicitudes <span
                                class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-calendar-day"></i></span>
                            <input type="date"
                                class="form-control rd-filter-input @error('fecha_inicio_solicitud') is-invalid @enderror"
                    ...
                    <div class="col-md-6 form-group mb-3">
                        <label class="font-weight-bold">Fecha de Fin de Solicitudes <span
                                class="text-danger">*</span></label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-calendar-check"></i></span>
                            <input type="date"
                                class="form-control rd-filter-input @error('fecha_fin_solicitud') is-invalid @enderror"
                ...
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" min="1"
                                class="form-control rd-filter-input @error('cupos_maximos') is-invalid @enderror"
                                name="cupos_maximos" value="{{ old('cupos_maximos', $jornada->cupos_maximos) }}"
                    ...
                    <div class="col-md-6 form-group mb-3 d-flex align-items-center">
                        <div class="custom-control custom-switch mt-4">
                            <input type="checkbox" class="custom-control-input" id="activa" name="activa" value="1" {{ old('activa', $jornada->activa) ? 'checked' : '' }}>
                            <label class="custom-control-label font-weight-bold" for="activa">Jornada Activa</label>
                            <small class="d-block text-muted">Las jornadas inactivas no permiten a los estudiantes
                                postularse.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 form-group mb-3">
                        ...
                        <textarea
                            class="form-control rd-filter-input @error('descripcion_jornada') is-invalid @enderror"
                            name="descripcion_jornada" rows="4"
