<x-app-layout>
            ...
            <div style="background-color: var(--bg-card); border-color: var(--border-color);"
                ...
                <form action="{{ route('admin.salud.maestros.categorias.index') }}" method="GET"
                    ...
                    <input type="text" name="buscar" value="{{ request('buscar') }}"
                        ...
                        class="w-full pl-10 pr-4 py-2.5 rounded-xl border text-sm font-medium focus:outline-none focus:ring-2 focus:ring-sky-500' : 'focus:ring-rose-500 transition-all">
                </form>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800/60 text-xs font-medium">
                            @forelse($categorias as $categoria)
                                <x-table-row :id="$categoria->id">
                                    ...
                                    <x-table-actions :id="$categoria->id" baseUrl="admin/salud/maestros/categorias"
                                        :status="$categoria->activo" :show="false" :on-edit="'abrirModalEditarCategoria(' .
                                            json_encode($categoria) .
                                            ', `' .
                                            route('admin.salud.maestros.categorias.update', $categoria->id) .
                                            '`)'" />
    ...
    <x-categoria-modal :store-route="route('admin.salud.maestros.categorias.store')" :tipo-producto-id="2" />
