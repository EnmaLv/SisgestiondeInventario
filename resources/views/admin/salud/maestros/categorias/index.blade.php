<x-app-layout>
    <div class="pt-6 pb-12 min-h-[calc(100vh-4rem)]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div style="background-color: var(--bg-card); border-color: var(--border-color);"
                ...
                <form action="{{ route('admin.salud.maestros.categorias.index') }}" method="GET"
                ...
                <div class="flex items-center gap-3 shrink-0">
                    ...
                    <div class="flex items-center gap-2 px-3 py-2 rounded-xl border"
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <div
                                class="w-10 h-6 bg-gray-200 dark:bg-gray-700 rounded-full peer peer-checked:bg-sky-600 transition-colors relative after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-4">
                            </div>
                        </label>
                    </div>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr
                                ...
                                <th class="px-6 py-4 text-center">Descripcion</th>
                                        ...
                                        <div id="panel-{{ $categoria->id }}" class="acciones-panel">
                                            <div
                                                ...
                                                <button type="button"
                                                    ...
                                                    onclick="abrirModalEditarCategoria({{ json_encode($categoria) }}, '{{ route('admin.salud.maestros.categorias.update', $categoria->id) }}')">
                                                    <i class="fas fa-edit"></i> Editar
                                                </button>

                                                @if ($categoria->activo == true)
                                                    <form id="form-toggle-{{ $categoria->id }}"
                                                        action="{{ url('admin/salud/maestros/categorias/' . $categoria->id) }}"
    ...
    <x-categoria-modal :store-route="route('admin.salud.maestros.categorias.store')"
    :tipo-producto-id="2" />
    ...
    <script>
        ...
        document.getElementById('estadoToggle').addEventListener('change', function() {
            ...
            window.location.href = "{{ route('admin.salud.maestros.categorias.index') }}?" + params.toString();
        });
