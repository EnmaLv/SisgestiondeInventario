...
@section('content_header')
    <div class="rd-card p-4 mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h1 class="m-0 rd-title-sm" style="font-size:1.4rem;">Crear Nuevo Envase Primario</h1>
    ...
    <div class="row">
        <div class="col-md-12 m-auto">
            <div class="rd-card p-4">
                ...
                <form action="{{ route('admin.salud.maestros.envases_primarios.store') }}" method="POST" class="rd-prevent-double-submit">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control rd-filter-input" id="nombre" name="nombre"
                                placeholder="Ingrese el nombre del envase primario" value="{{ old('nombre') }}">
                        </div>
                        @error('nombre')
