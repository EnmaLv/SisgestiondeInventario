        ...
        <div class="rd-card-body">
            <div class="rd-card-header rd-header-space">
                ...
                <div class="rd-actions">
                    ...
                    <form action="{{ route('admin.salud.maestros.medicamentos.index') }}" method="GET" class="rd-search-inline" role="search">
                        <input type="hidden" name="activo" value="{{ request('activo', 1) }}">
                        <input type="hidden" name="categoria" value="{{ request('categoria') }}">

                        <input type="text" name="buscar" value="{{ request('buscar') }}" class="rd-search-input" placeholder="Buscar medicamento..." />
            ...
            <div class="collapse {{ request('categoria') ? 'show' : '' }}" id="filters"> 
                <div class="rd-filters">
                    <form action="{{ route('admin.salud.maestros.medicamentos.index') }}" method="GET" class="rd-filters-form">
                        <input type="hidden" name="activo" value="{{ request('activo', 1) }}">
                        ...
                        <div class="rd-filter-actions">
                            ...
                            <a href="{{ route('admin.salud.maestros.medicamentos.index', ['activo' => request('activo', 1)]) }}" class="rd-btn rd-btn-default text-decoration-none d-inline-flex align-items-center justify-content-center">
                            ...
                            <tr>
                                ...
                                <td class="text-center" data-label="Acciones">
                                    <div class="rd-action-group">
                                        ...
                                        @else
                                            <form action="{{ url('admin/salud/maestros/medicamentos/' . $producto->id . '/activar') }}"
                                                method="POST" 
                                                class="form-activate" 
                                                style="display:inline;">
                                                @csrf
