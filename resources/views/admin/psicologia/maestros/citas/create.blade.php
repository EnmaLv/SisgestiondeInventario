            ...
            @if(!empty($tieneCitaPendiente))
                <div class="bg-white dark:bg-gray-800 shadow-xl rounded-3xl border border-blue-200 dark:border-blue-800 overflow-hidden">
                    <div class="p-8 text-center space-y-4">
                        ...
                        <a href="{{ route('admin.psicologia.maestros.citas.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold text-sm transition shadow-lg shadow-blue-500/20">
