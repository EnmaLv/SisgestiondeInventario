<x-app-layout>
    @php
        ...
        $segmentosIniciales = old('segmentos') 
            ...
            : ((isset($plantilla->segmentos) && count($plantilla->segmentos) > 0) ? array_values($plantilla->segmentos) : ['']);
    @endphp
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="mt-1 text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">
                    Modificación del instrumento clínico: <strong class="text-{{ $themeColor }}-600 dark:text-{{ $themeColor }}-400">{{ $plantilla->titulo }}</strong>
                </p>
            </div>
            ...
            <div style="background-color: var(--bg-card); border-color: var(--border-color); color: var(--text-main);"
                ...
                <form action="{{ route('admin.psicologia.maestros.plantillas.update', $plantilla->id) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="descripcion_general" id="descripcion_general" value="{{ old('descripcion_general', $plantilla->descripcion_general) }}"
                                style="background-color: rgba(0,0,0,0.02); border-color: var(--border-color); color: var(--text-main);"
