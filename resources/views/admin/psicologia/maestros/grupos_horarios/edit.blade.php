        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.psicologia.maestros.grupos_horarios.update', $grupoHorario->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex items-center justify-end mt-6">
                            <a href="{{ route('admin.psicologia.maestros.grupos_horarios.index') }}" class="mr-4 text-gray-600 hover:text-gray-900">Cancelar</a>
                            <x-primary-button>
                                {{ __('Actualizar Grupo') }}
                            </x-primary-button>
                        </div>
