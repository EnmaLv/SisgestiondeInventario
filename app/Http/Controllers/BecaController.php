...
class BecaController extends Controller
{
    ...
    {
        return view('admin.becas.create', $this->datosFormulario());
    }
    ...
    public function edit(Beca $beca)
    {
        ...
        return view('admin.becas.edit', $this->datosFormulario() + compact('beca'));
    }
    ...
    {
        return new BecaResource($beca->load(['beneficios']));
    }

    private function datosFormulario(): array
    {
        return [
            'beneficios' => Beneficio::where('status', true)->orderBy('nombre_beneficio')->get(),
        ];
    }
}
