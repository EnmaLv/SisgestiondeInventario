...
function inicializarValidacionesCrear() {
    ...
    if (nombreInput && municipioSelect) {
                ...
                if (!validarFormatoNombre(valor)) {
                    ...
                    if (municipioId) {
                        timeoutId = setTimeout(async () => {
                            ...
                            const existe = await verificarLocalidadExistente(
                                valor,
                                municipioId
                            );
                            ...
                            if (existe) {
                                mostrarError(
                                    this,
                                    "Ya existe una localidad con este nombre en el municipio seleccionado"
                                );
                            } else if (haHechoBlur) {
                                mostrarError(this, "");
                            }
        ...
        municipioSelect.addEventListener("change", function () {
            ...
            if (nombreValor && municipioId) {
                ...
                verificarLocalidadExistente(nombreValor, municipioId).then(
                    (existe) => {
                        console.log(
                            "Verificación después de cambiar municipio:",
                            existe
                        );
                        if (existe) {
                            mostrarError(
        ...
        nombreInput.addEventListener("blur", function () {
            ...
            if (!valor) {
                ...
                verificarLocalidadExistente(valor, municipioId).then(
                    (existe) => {
    ...
    form.addEventListener("submit", async function (event) {
        ...
        if (nombreInput) {
            ...
            if (!valor) {
                ...
                console.log(
                    "Resultado de verificación antes de enviar:",
                    existe
                );
                if (existe) {
                    mostrarError(
    ...
    console.log("Validaciones inicializadas Exitosamente");
}
